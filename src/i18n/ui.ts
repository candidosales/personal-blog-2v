...
export const ui = {
	en: {
		...
		'quote.alexandrePatricio': 'Those who never stop never listen. Those who never listen never meet.',
		'about.title': 'About',
	...
	'pt-br': {
		...
		'volunteer.4.title': 'CELPIP Speaking Countdown',
		'volunteer.4.description': 'Ferramenta para auxiliar no treinamento para o teste de conversação CELPIP',
		...
		'quote.alexandrePatricio': 'Quem nunca para, nunca se escuta. Quem nunca se escuta, nunca se encontra.',
		'about.title': 'Sobre',

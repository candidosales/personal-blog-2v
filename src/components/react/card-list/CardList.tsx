              ...
              <div className="header">
                ...
                <div className="header-inner">
                  <div className="content-wrapper">
                    <motion.h2 layoutId={`title-${activeGame.title}`} className="game-title">
                      {activeGame.title}
                    </motion.h2>
                    <motion.p
                  ...
                  <motion.button layoutId={`button-${activeGame.title}`} className="button">
                    Get
                  </motion.button>
                </div>
              </div>
        ...
        {GAMES.map((game) => (
          ...
          >
            ...
            <div className="game-wrapper">
              ...
              <motion.button layoutId={`button-${game.title}`} className="button">
                Get
              </motion.button>
            </div>
          </motion.li>
